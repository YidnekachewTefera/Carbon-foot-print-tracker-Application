<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="carbon_footprint_application.Account.Register" %>
    ...
    <main aria-labelledby="title">
        ...
        <div class="row">
            <div class="offset-md-2 col-md-10">
                <asp:Button runat="server" OnClick="CreateUser_Click" Text="Register" CssClass="btn btn-outline-success" />
            </div>
        </div>
    </main>
</asp:Content>
